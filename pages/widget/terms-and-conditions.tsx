...
export default function TermsAndConditionsPage({siteConfigData}) {
  ...
  return <Layout fullWidthGradientVariant>
    <Head>
    ...
    <Content>
      <div>
        ...
        <p>These Terms and Conditions (the "Terms") govern the integration of the CoW Swap Widgetr (the “Widget”). The
        ...
        <p>By integrating and using the Widget, Partner acknowledges that it has read, understood, and agreed to be
        ...
        <p>We may terminate or suspend your access to the Widget immediately, without prior notice or liability, if
          ...
          Products will immediately cease.</p>
        <h2>Change of these Terms</h2>
        <p>We may amend these Terms at our sole discretion. We regularly do so. Every time you wish to access the
        ...
        <h2>The Widget</h2>
        <p>The Widget is an iframe solution mirroring the web-hosted user interface (the “Interface”) published at <a
          target="_blank" rel="noreferrer" href="https://swap.cow.fi/">
          https://swap.cow.fi/
        </a> and providing access to CoW Protocol and allowing users to submit orders into the Interface and exchange
          compatible tokens using the unique features of the Protocol.</p>
        <p>Please consult our documentation for more information on <a target="_blank" rel="noreferrer"
                                                                       href="https://docs.cow.fi/cow-protocol/tutorials/widget">
          CoW Widget
        </a> and the Interface.</p>
        <p>The <a target="_blank" rel="noreferrer"
                  href="https://swap.cow.fi/#/terms-and-conditions#welcometohttpscowfi">
          Terms &amp; Conditions
        </a> for the use of the Interface apply to the Widget. It is your duty to ensure that all persons who access the
          Widget through your website are aware of the Interface’s <a target="_blank" rel="noreferrer"
                                                                      href="https://swap.cow.fi/#/terms-and-conditions">
            Terms &amp; Conditions
          </a> and that they comply with them.</p>
        <h2>Widget Integration</h2>
        <p>The Partner may integrate the Widget into their website or application in accordance with the Provider's
          integration guidelines and these Terms.</p>
        <p>The Partner may customize the design and appearance of the Widget within reasonable limits, provided that
          the
          Provider's branding and logos remain visible.</p>
        <h2>Obligations of the Partner</h2>
        <p>You are prohibited from misusing the the Widget, the Interface, the Protocol or its infrastructure by
          knowingly introducing any material that is:</p>
        <ul>
          <li>Malicious, including viruses, worms, Trojan horses, and other harmful software;</li>
          <li>Technologically harmful, including attempts to disrupt or damage the Widget, the Interface, the Protocol
        ...
        <p>The Provider grants the Partner a limited, non-exclusive, non-transferable, revocable license to integrate
          and use the Widget solely for the purpose of providing access to the Interface to the Partner's users.</p>
        ...
        <p>The Partner is solely responsible for ensuring compliance with all applicable laws and regulations in their
          jurisdiction.</p>
        <h2>Indemnification</h2>
        <p>The Partner shall indemnify, defend, and hold harmless the Provider, its affiliates, and their agents from
          and against any and all claims, liabilities, damages, losses, and expenses, including reasonable attorneys'
          fees and costs, arising out of or relating to the Partner's use of the Widget or breach of these Terms.</p>
        <h2>Breach of Terms</h2>
        <p>In the event of a breach of these Terms, the Provider may immediately terminate your use of the Widget or
          participation in the Program without notice.</p>
        <h2>Termination</h2>
        <p>The&nbsp; Provider may terminate this Agreement at any time and revoke the Partner's license to use the
          Widget at any time, with or without cause, upon written notice to Partner.</p>
        <p>Upon termination, the Partner shall immediately cease all use of the Widget and remove it from its website
          or
          application.</p>
        ...
        <p>In the event a Dispute cannot be resolved amicably, you must first refer the Dispute to proceedings under
          the
          International Chamber of Commerce (“ICC”) Mediation Rules, which Rules are deemed to be incorporated by
          reference into this clause. The place of mediation shall be London, United Kingdom. The language of the
          mediation proceedings shall be English.</p>
        <p>If the Dispute has not been settled pursuant to the ICC Mediation Rules within forty (40) days following
          the
          ...
          accordance
          with the said Rules. The seat of Arbitration shall be London, United Kingdom. The governing law of this
          arbitration clause shall be the laws of England and Wales. The language of the arbitration shall be English.
          The Emergency Arbitrator Provisions shall not apply.</p>
        <h3>Final Jurisdiction</h3>
        <p>If the Dispute cannot be resolved for legal reasons in accordance with the procedures described above, you
          and we agree that the courts of England and Wales shall have exclusive jurisdiction to resolve the
          Dispute.</p>
        <h2>Miscellaneous</h2>
        <h3>Entire agreement</h3>
        <p>These Terms constitute the entire and exclusive agreement between us and you regarding its subject matter,
          ...
          in
          these Terms, though nothing in this clause shall limit or exclude any liability for fraud.
        </p>
        <h3>No waiver and no assignment</h3>
        <p>You may not assign, transfer or delegate any of your rights or duties arising out of or in connection with
          these Terms to a third party. Any such assignment or transfer shall be void and shall not impose any
          obligation or liability on us to the assignee or transferee.</p>
        <p>Any delay or omission by us in relation to the exercise of any right granted by law or under these Terms
          shall not as a result exclude or prevent the later exercise of such a right.</p>
        <h3>Severability</h3>
        <p>If any provision or part-provision of these Terms is or becomes invalid, illegal or unenforceable, it shall
          ...
          and enforceability of the rest of these Terms.</p>
        <h3>Governing law</h3>
        <p>This Agreement shall be governed by and construed in accordance with the substantive laws of
          England &amp; Wales without regard to conflict of laws principles.
        </p>
      </div>
    </Content>
  </Layout>
