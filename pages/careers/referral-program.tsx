...
import { Section, Title, SubTitle } from 'const/styles/pages/content'

export default function Jobs({ siteConfigData }) {
  const { title } = siteConfigData

  return (
    <>
      <Head>
        <title>Career Referral Program - {title}</title>
      </Head>
      <Layout>
        <Section>
        ...
        <Section>
          ...
          <ul>
            ...
            <li>Any individual who is not bound by non-compete agreements or any other similar agreements that would prohibit CoW from engaging with them.</li>
          </ul>
          ...
          <ul>
            <li>The Referrer becomes eligible to receive the full referral bonus of five thousand USDC or USD (5,000) after six (6) months from the Candidate&apos;s start date, provided that the Candidate remains providing services to CoW during this period. The Referrer can decide if they want to be paid in USDC or USD.</li>
            <li>The referral bonus is excl. VAT (VAT can be added), but net of any other tax, such as, income tax or withholding tax.</li>
            <li>The referral bonus will be paid to the Referrer within thirty (30) days receiving a legally compliant invoice (incl. Name, Address and VAT number, either USDC-Ethereum address or IBAN) of the Referrer.</li>
