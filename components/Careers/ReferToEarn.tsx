  ...
  return (
    <>
      ...
      <Section>
        ...
        <p>
          Sounds like a long time to wait? Allow us to explain! 😊 At CoW, we prioritize quality and make substantial
          investments in our people. We consider this our utmost priority and exercise great caution when onboarding new
          individuals. We genuinely care about ensuring that we bring on board the right people who align with our
          values and goals.
          <br />
          <br />
          <b>
        ...
        <h3>Conditions:</h3>
        <h4>Referrer Eligibility. Who is eligible to participate in this Program?</h4>
        <ul>
          <li>Individuals (or entities) who are not currently engaged in providing contracting services to CoW.</li>
          <li>
            Individuals (or entities) who are not affiliated with, employed by, or acting as consultants for staffing or
            recruiting agencies or any other third party for CoW at the time of making referrals or receiving payments
            for such referrals.
          </li>
          ...
          <li>
            If two or more Referrers refer the same Candidate, then only the <b>first</b> Referrer provided by such
        ...
        <ul>
          <li>
            To apply for a specific role at CoW, <b>Candidates</b> are required to submit their application through the
            official website: <a href="https://cow.fi/careers">https://cow.fi/careers</a>.{' '}
            <b>
          ...
          <li>
            CoW is not obligated to disclose the reason for rejecting a Candidate to a Referrer or to inform them if the
            Candidate was not selected for the next steps in the interview process.
          </li>
        ...
        <ul>
          <li>
            Contracting to CoW includes a number of routes, including EORs. Grants (other than core contributors) are
            not counted into these routes and Grant recipients are eligible to make referrals.
          </li>
          <li>The decision regarding the Candidate&apos;s submission order is based solely on our judgment.</li>
          <li>
            We can terminate this program at any point in time and at our sole discretion, without notice. Of course,
            presently referred Candidates remain part of the program.
          </li>
          <li>
            The conditions of the referral program will be shared via email with the Referrer, and we will require
            confirmation by responding to the email once a Candidate accepts a Job Offer. Unfortunately, the Referrer
            will not qualify for a bonus if we do not receive this confirmation.
          </li>
        </ul>
      </Section>
    </>
