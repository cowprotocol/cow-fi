...
export const FOOTER_LINK_GROUPS: FooterLinkGroup[] = [
  ...
  },
  {
    label: 'About', links: [
      ...
      { label: 'CoW ToC', url: 'https://swap.cow.fi/#/terms-and-conditions', type: 'external' },
      { label: 'CoW Privacy Policy', url: 'https://swap.cow.fi/#/privacy-policy', type: 'external' },
      { label: 'CoW Cookie Policy', url: 'https://swap.cow.fi/#/cookie-policy', type: 'external' },
